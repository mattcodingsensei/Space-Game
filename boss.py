...
#fight   
  ...
  def boss_action (self,pl):
    if self.current_move == "attack":
      self.d_print_a ("The boss attacked.\n")
      self.boss_attack(pl)
  ...
  def bAlias(self):
    alias = ["the defender", "the mighty", "the noble"]

    
  def boss_fight(self):
    self.d_print_b ("whatever we want to do for the boss fight")